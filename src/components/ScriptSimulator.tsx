    ...
    <div className="w-full glass-panel rounded-2xl border border-white/5 p-4 sm:p-6 md:p-8 shadow-2xl relative" id="script-simulator">
      ...
      <div className="border-b border-white/10 pb-4 mb-6">
        <h3 className="text-lg font-bold text-white flex items-center gap-2">
          📞 محاكي حوارات تأكيد الطلبات الهاتفية المبيعاتية
        </h3>
        <p className="text-xs text-white/50 mt-1">اضغط على نوع المشتري لتعلم السيناريو الذهبي الأنسب لإقناعه وإغلاق الصفقة</p>
      </div>
