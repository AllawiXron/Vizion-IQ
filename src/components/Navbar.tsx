        ...
        <div className="max-w-7xl mx-auto h-full px-4 sm:px-6 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            <button
              ...
              title="أسرار النخبة المكتومة للتجارة العراقية"
            >
              <span>🔑</span>
              <span>أسرار النخبة</span>
            </button>

            {/* Admin trigger button */}
            <button
              onClick={onOpenAdmin}
              className="p-1.5 bg-white/5 hover:bg-[#D4A017]/10 border border-white/10 hover:border-[#D4A017]/30 rounded-xl text-white/80 hover:text-[#F0C040] transition-all cursor-pointer flex items-center gap-1.5 text-xs font-bold"
              title="بوابة التحكم الإدارية"
            >
              <Settings className="w-4 h-4 animate-spin [animation-duration:15s]" />
        ...
        <div className="space-y-3 overflow-y-auto max-h-[60vh] no-scrollbar">
          ...
          >
            <span className="flex items-center gap-2">
              <span>🔑</span>
              <span>خزنة أسرار النخبة المكتومة</span>
            </span>
        ...
        <div className="space-y-3 pt-6 border-t border-white/15">
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="py-3 px-4 bg-white/5 hover:bg-[#D4A017]/10 border border-white/10 rounded-xl text-white/80 hover:text-[#F0C040] transition-all cursor-pointer flex items-center justify-center gap-2 text-xs font-bold"
            >
            ...
            <button
              onClick={onLogout}
              className="py-3 px-4 bg-red-500/10 hover:bg-red-500/20 border border-red-500/20 rounded-xl text-red-400 hover:text-red-300 transition-all cursor-pointer flex items-center justify-center gap-2 text-xs font-bold"
            >
              <LogOut className="w-4 h-4" />
