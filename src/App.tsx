...
import EliteSecrets from "./components/EliteSecrets";
    ...
    <div className="relative min-h-screen bg-[#040B24] text-[#F0F4FF] overflow-x-hidden selection:bg-[#D4A017] selection:text-[#040B24]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 md:space-y-16">
        ...
        >
          ...
          <div className="text-center space-y-3 mb-12">
            ...
            <p className="text-sm md:text-base text-white/50 max-w-xl mx-auto font-light leading-relaxed">
              ٩ فصول متسلسلة بدقة للانطلاق بمبيعاتك من الصفر وحتى الملايين شهرياً
            </p>
        ...
        >
          {/* Header */}
          <div className="text-center space-y-3 mb-12">
            <div className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-[#D4A017]/10 text-xs text-[#F0C040] font-bold">
              <Star className="w-3.5 h-3.5 fill-[#D4A017]" />
              <span>خلاصة الدليل الذهبية</span>
            </div>
            
            <h2 className="text-3xl md:text-5xl font-black text-white">المعادلة المليونية النهائية للمبيعات</h2>
            <p className="text-sm md:text-base text-white/50 max-w-xl mx-auto leading-relaxed font-light">
              السر الذي يفصل بين التجارة الإلكترونية العشوائية والامبراطوريات المليونية في العراق
            </p>
          </div>

          {/* Premium Glass Card */}
          <div className="glass-panel-gold rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden border border-white/10 max-w-4xl mx-auto text-center space-y-8">
            <div className="absolute top-0 right-0 w-16 h-16 border-t-2 border-r-2 border-[#D4A017] rounded-tr-3xl" />
            <div className="absolute bottom-0 left-0 w-16 h-16 border-b-2 border-l-2 border-[#D4A017] rounded-bl-3xl" />
            
            <div className="text-4xl">🏆🛡️📈</div>

            <div className="space-y-4">
              <p className="text-lg md:text-2xl font-black text-white leading-relaxed">
                إن المعادلة الأساسية للتجارة الإلكترونية الناجحة في العراق ترتكز على أربعة أركان أساسية لا غنى عنها:
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-6">
                <div className="bg-white/5 border border-white/5 p-4 rounded-xl text-center">
                  ...
                  <span className="text-xs font-bold text-white block">١. خطاف إعلاني مميز</span>
                  <p className="text-[10px] text-white/50 leading-relaxed font-light mt-1">يوقف تصفح الزبون بلغة عراقية صريحة تجذب الانتباه بالثانية الأولى.</p>
                </div>
                <div className="bg-white/5 border border-white/5 p-4 rounded-xl text-center">
                  <span className="text-xl mb-1.5 block">⚡</span>
                  <span className="text-xs font-bold text-white block">٢. صفحة هبوط سريعة</span>
                  <p className="text-[10px] text-white/50 leading-relaxed font-light mt-1">استمارة سهلة جداً تطلب فقط المعلومات اللازمة لإتمام المبيعة.</p>
                </div>
                <div className="bg-white/5 border border-white/5 p-4 rounded-xl text-center">
                  <span className="text-xl mb-1.5 block">📞</span>
                  <span className="text-xs font-bold text-white block">٣. مكالمة فورية ودية</span>
                  <p className="text-[10px] text-white/50 leading-relaxed font-light mt-1">تأكيد الطلب خلال نصف ساعة يمنع برود رغبة المشتري تكراراً.</p>
                </div>
                <div className="bg-white/5 border border-white/5 p-4 rounded-xl text-center">
                  <span className="text-xl mb-1.5 block">📦</span>
                  <span className="text-xs font-bold text-white block">٤. فحص الطرد عند الباب</span>
                  <p className="text-[10px] text-white/50 leading-relaxed font-light mt-1">الميزة الكبرى لكسر الشك وإعطاء ثقة حرة لمصلحة الزبون.</p>
                </div>
              </div>
            </div>

            <div className="w-24 h-[1px] bg-[#D4A017] mx-auto" />

            <div className="space-y-2">
              <p className="text-xs text-[#F0C040] font-bold">رسالة أخيرة للمسوق المتميز:</p>
              <p className="text-xs md:text-sm text-white/80 max-w-2xl mx-auto leading-relaxed font-light">
                التجارة الإلكترونية ليست مجرد حظ، بل هي منظومة متكاملة من الخطوات الرياضية والمنطقية. التزامك بخطة الـ ٣٠ يوماً ومراجعتك المستمرة لأرقامك وحاسبة العائد هي ركيزتك للنجاح. نراك في لوحة الأرباح!
              </p>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-[#040B24] border-t border-white/10 mt-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-right">
            ...
            <div className="space-y-3 max-w-sm">
              <span className="text-xl md:text-2xl font-black text-white flex items-center justify-center md:justify-start gap-2">
                <span>📈</span>
                <span>دليل المبيعات العراقي</span>
              </span>
              <p className="text-xs text-white/50 leading-relaxed font-light">
                منصة النخبة لتعلم التجارة الإلكترونية، إعلانات السوشيال ميديا، وإدارة العمليات الهاتفية والدفع عند الاستلام بأسلوب علمي دقيق.
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center md:justify-end gap-3.5 text-xs font-bold text-[#F0C040]">
              ...
              <button
                ...
                className="hover:text-white transition-colors cursor-pointer flex items-center gap-1 text-[#F0C040]"
              >
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-[11px] text-white/30 text-center">
            <span>© 2026 دليل المبيعات العراقي. جميع الحقوق محفوظة للنخبة المسجلة.</span>
